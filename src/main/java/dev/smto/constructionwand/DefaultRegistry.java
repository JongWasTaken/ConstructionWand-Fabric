...
public class DefaultRegistry extends ModRegistry {
    ...
    public void registerAll() {
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("stone_wand"), stoneWand);
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("iron_wand"), ironWand);
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("diamond_wand"), diamondWand);
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("infinity_wand"), infinityWand);
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("core_angel"), coreAngel);
        net.minecraft.registry.Registry.register(Registries.ITEM, ConstructionWand.id("core_destruction"), coreDestruction);
